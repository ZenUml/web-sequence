!(function () {
  ...
  function a(e, t) {
    if ((void 0 === t && (t = !1), 'string' == typeof e)) {
      ...
      e = t ? s(e) : fe[e] || (fe[e] = s(e));
    }
    return e;
  }
  function s(e, t) {
    return t ? e.querySelector(t) : ge.querySelector(e);
  }
  function l(e, t) {
    return [].slice.call(t ? e.querySelectorAll(t) : ge.querySelectorAll(e));
  }
  function u(e, t) {
    return (e = ge.createElement(e)), t && (e.innerHTML = t), e;
  }
  function c(e, t) {
  ...
  function v(e) {
    var t =
      ...
      (e.name
        ? '<h1><a class="app-name-link" data-nosearch>' + e.name + '</a></h1>'
        : '') +
  ...
  function y() {
    var e = ', 100%, 85%';
    return (
      '<section class="cover" style="background: linear-gradient(to left bottom, hsl(' +
      (Math.floor(255 * Math.random()) + e) +
      ') 0%,hsl(' +
      (Math.floor(255 * Math.random()) + e) +
      ') 100%)"><div class="cover-main"></div><div class="mask"></div></section>'
    );
  }
  function b(e, t) {
    return (
      ...
      e && e.length
        ? (e.forEach(function (e) {
            (t +=
              ...
              e.children &&
                (t +=
                  '<li><ul class="children">' + b(e.children) + '</li></ul>');
          }),
          t)
        : ''
    );
  ...
  function x() {
    var e = u('div');
    e.classList.add('progress'), c(me, e), (pe = e);
  }
  function _(e, t) {
    void 0 === t && (t = !1);
          ...
          then: function (o, a) {
            if ((void 0 === a && (a = n), t)) {
              var s = setInterval(function (e) {
                return xe({ step: Math.floor(5 * Math.random() + 1) });
              }, 500);
              i('progress', xe),
                i('loadend', function (e) {
                  xe(e), clearInterval(s);
                });
            }
            i('error', a),
              i('load', function (t) {
    ...
    return (
      e.forEach(function (e) {
        var i = e.level || 1,
          o = i - 1;
        i > t ||
          (r[o] ? (r[o].children = (r[o].children || []).concat(e)) : n.push(e),
          (r[i] = e));
      }),
      n
    );
  ...
  function A(e) {
    return e
      ...
      .replace(/:(\w+?):/gi, (be && window.emojify) || $)
      .replace(/__colon__/g, ':');
  }
  function P(e) {
    var t = {};
  ...
  function O(e, t) {
    ...
    for (var r in e)
      t.indexOf(r) > -1 ||
        n.push(e[r] ? (Me(r) + '=' + Me(e[r])).toLowerCase() : Me(r));
  ...
  function q(e, t) {
    var n = function (e) {
      return me.classList.toggle('close');
    };
    (e = a(e)),
    ...
    var r = a('.sidebar');
    ke &&
      p(me, 'click', function (e) {
        return me.classList.contains('close') && n();
      }),
  ...
  function R(e, t, n, r) {
    ...
    return (
      ...
      r && (ge.title = i ? i.innerText + ' - ' + ze : ze),
      i
    );
  }
  function F(e, t) {
    ...
    if (Ye) {
      for (
        var t,
          ...
          c = ((u && u.scrollTop) || document.body.scrollTop) - Ze,
          h = 0,
          p = r.length;
        h < p;
        h += 1
      ...
      if (t) {
        var f = De[B(e, t.getAttribute('data-id'))];
        if (
          f &&
          f !== o &&
          ...
          (o = f),
          !We && me.classList.contains('sticky'))
        ) {
          var g = n.clientHeight,
            m = o.offsetTop + o.clientHeight + 40,
            v = o.offsetTop >= i.scrollTop && m <= i.scrollTop + g,
            y = m - 0 < g,
            b = v ? i.scrollTop : y ? 0 : m - g;
          n.scrollTop = b;
        }
      }
    }
  ...
  function I(e) {
    var t = s('.cover.show');
    Ze = t ? t.offsetHeight : 0;
    for (
      var n = a('.sidebar'), r = l(n, 'li'), i = 0, o = r.length;
      i < o;
      i += 1
    ) {
      var u = r[i],
      ...
      if (c) {
        ...
        h && (De[decodeURIComponent(h)] = u);
      }
    }
    if (!ke) {
      var v = e.getCurrentPath();
      d('scroll', function () {
        return z(v);
      }),
        p('scroll', function () {
  ...
  function D(e, t) {
    if (t) {
      ...
      var r = De[B(e, t)],
        i = a('.sidebar'),
        o = s(i, 'li.active');
      o && o.classList.remove('active'), r && r.classList.add('active');
    }
  }
  function W(e) {
    void 0 === e && (e = 0), (Ge.scrollTop = !0 === e ? 0 : Number(e));
  }
  function U() {
  ...
  function Z(e) {
    e || (e = 'not found'),
      ...
      !1 === this.config.executeScript || void 0 === window.Vue || U()
        ? this.config.executeScript && U()
        : setTimeout(function (e) {
  ...
  function G(e) {
    var n = a('.app-name-link'),
      r = e.config.nameLink,
      i = e.route.path;
    if (n)
      if (t(e.config.nameLink)) n.setAttribute('href', r);
  ...
  function X(e) {
    ...
    i
      ...
      h(a, r),
      t.themeColor &&
        (ge.head.appendChild(u('div', w(t.themeColor)).firstElementChild),
        Se(t.themeColor)),
      e._updateRender(),
      f(me, 'ready');
  }
  function V(e, t, n) {
    var r = Object.keys(t).filter(function (t) {
      return (Xe[t] || (Xe[t] = new RegExp('^' + t + '$'))).test(e) && e !== n;
    })[0];
    return r ? V(e.replace(Xe[r], t[r]), t, e) : e;
  }
  function J(e) {
    return /\.(md|html)$/g.test(e)
      ? e
      : /\/$/g.test(e)
        ? e + 'README.md'
        : e + '.md';
  ...
  function K(e) {
    e.router.normalize(),
      ...
      me.setAttribute('data-page', e.route.file);
  }
  function ee(e) {
    var t,
      n = e.config,
      r = n.routerMode || 'hash';
    (t = 'history' === r && we ? new Ke(n) : new Qe(n)),
      (e.router = t),
      K(e),
      (et = e.route),
      t.onchange(function (t) {
        if ((K(e), e._updateRender(), et.path === e.route.path))
          return void e.$resetEvents();
        e.$fetch(), (et = e.route);
      });
  }
  function te(e) {
    q('button.sidebar-toggle', e.router),
      e.config.coverpage ? !ke && p('scroll', N) : me.classList.add('sticky');
  }
  function ne(e, t, n, r, i, o) {
    (e = o ? e : e.replace(/\/$/, '')),
      (e = Ne(e)) &&
        _(i.router.getFile(e + n) + t).then(r, function (o) {
          return ne(e, t, n, r, i);
        });
  }
  function re(e) {
    var t = e.config,
      n = t.loadSidebar;
    if (e.rendered) {
      var r = R(e.router, '.sidebar-nav', !0, !0);
      n && r && (r.parentNode.innerHTML += window.__SUB_SIDEBAR__),
        e._bindEventOnRendered(r),
        e._fetchCover(),
        e.$resetEvents(),
        o(e, 'doneEach'),
        o(e, 'ready');
  ...
  var ae = e(function (e) {
    ...
    se =
      ...
      function (e) {
        for (
          var t = arguments, n = Object.prototype.hasOwnProperty, r = 1;
          r < arguments.length;
          r++
        ) {
          var i = Object(t[r]);
  ...
  if (ue) {
    for (var ce in le) {
      var he = ue.getAttribute('data-' + ae(ce));
      t(he) && (le[ce] = '' === he || he);
    }
    !0 === le.loadSidebar && (le.loadSidebar = '_sidebar.md'),
      !0 === le.loadNavbar && (le.loadNavbar = '_navbar.md'),
      !0 === le.coverpage && (le.coverpage = '_coverpage.md'),
      !0 === le.repo && (le.repo = ''),
      !0 === le.name && (le.name = '');
  }
  window.$docsify = le;
  var pe,
    ...
    ke = be && document.body.clientWidth <= 600,
    we =
      be &&
      (function () {
        return (
    ...
    xe = function (e) {
      ...
      !pe && x(),
        i
          ? ((t = parseInt(pe.style.width || 0, 10) + i), (t = t > 80 ? 80 : t))
          : (t = Math.floor((n / r) * 100)),
        (pe.style.opacity = 1),
        (pe.style.width = t >= 95 ? '100%' : t + '%'),
        t >= 95 &&
          (clearTimeout(de),
          (de = setTimeout(function (e) {
            (pe.style.opacity = 0), (pe.style.width = '0%');
          }, 200)));
    },
    _e = {},
    Se = function (e) {
    ...
    Ee = function (e) {
      var t = [],
        n = 0;
      return (
        e.replace(Ce, function (r, i, o) {
          t.push(e.substring(n, o - 1)),
            (n = o += r.length + 1),
            t.push(function (e) {
              return (
                '00' + ('string' == typeof Le[r] ? e[Le[r]]() : Le[r](e))
              ).slice(-r.length);
            });
        }),
    ...
    $e = C(function (e, t) {
      (function () {
        ...
        (h.bullet = /(?:[*+-]|\d+\.)/),
          (h.item = /^( *)(bull) [^\n]*(?:\n(?!\1bull )[^\n]*)*/),
          (h.item = s(h.item, 'gm')(/bull/g, h.bullet)()),
          (h.list = s(h.list)(/bull/g, h.bullet)(
            'hr',
            '\\n+(?=\\1?(?:[-*_] *){3,}(?:\\n+|$))',
          )('def', '\\n+(?=' + h.def.source + ')')()),
          (h.blockquote = s(h.blockquote)('def', h.def)()),
          (h._tag =
            '(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:/|[^\\w\\s@]*@)\\b'),
          (h.html = s(h.html)('comment', /<!--[\s\S]*?-->/)(
            'closed',
            /<(tag)[\s\S]+?<\/\1>/,
          )('closing', /<tag(?:"[^"]*"|'[^']*'|[^'">])*?>/)(/tag/g, h._tag)()),
          (h.paragraph = s(h.paragraph)('hr', h.hr)('heading', h.heading)(
            'lheading',
            h.lheading,
          ...
          (t.prototype.token = function (e, t, n) {
            for (
              ...
              if (
                ((o = d.rules.newline.exec(e)) &&
                  ((e = e.substring(o[0].length)),
                  o[0].length > 1 && d.tokens.push({ type: 'space' })),
                (o = d.rules.code.exec(e)))
              )
                (e = e.substring(o[0].length)),
                  (o = o[0].replace(/^ {4}/gm, '')),
                  d.tokens.push({
              ...
              else if ((o = d.rules.fences.exec(e)))
                (e = e.substring(o[0].length)),
                  d.tokens.push({ type: 'code', lang: o[2], text: o[3] || '' });
              else if ((o = d.rules.heading.exec(e)))
                (e = e.substring(o[0].length)),
                  d.tokens.push({
                    type: 'heading',
                    depth: o[1].length,
                ...
                d.tokens.push(l);
              } else if ((o = d.rules.lheading.exec(e)))
                (e = e.substring(o[0].length)),
                  d.tokens.push({
                    type: 'heading',
                    depth: '=' === o[2] ? 1 : 2,
              ...
              else if ((o = d.rules.hr.exec(e)))
                (e = e.substring(o[0].length)), d.tokens.push({ type: 'hr' });
              else if ((o = d.rules.blockquote.exec(e)))
                (e = e.substring(o[0].length)),
                  d.tokens.push({ type: 'blockquote_start' }),
                  (o = o[0].replace(/^ *> ?/gm, '')),
                  d.token(o, t, !0),
                  d.tokens.push({ type: 'blockquote_end' });
              else if ((o = d.rules.list.exec(e))) {
                for (
                  e = e.substring(o[0].length),
                    a = o[2],
                    d.tokens.push({
                  ...
                  (l = o[c]),
                    ...
                    ~l.indexOf('\n ') &&
                      ((u -= l.length),
                      (l = d.options.pedantic
                        ? l.replace(/^ {1,4}/gm, '')
                        : l.replace(new RegExp('^ {1,' + u + '}', 'gm'), ''))),
                    d.options.smartLists &&
                      c !== p - 1 &&
                      ((s = h.bullet.exec(o[c + 1])[0]),
                      a === s ||
                    ...
                    d.token(l, !1, n),
                    d.tokens.push({ type: 'list_item_end' });
                d.tokens.push({ type: 'list_end' });
              } else if ((o = d.rules.html.exec(e)))
                (e = e.substring(o[0].length)),
                  d.tokens.push({
              ...
              else if (!n && t && (o = d.rules.def.exec(e)))
                (e = e.substring(o[0].length)),
                  (d.tokens.links[o[1].toLowerCase()] = {
                    href: o[2],
                    title: o[3],
                  });
                ...
                for (c = 0; c < l.cells.length; c++)
                  l.cells[c] = l.cells[c]
                    ...
                    .split(/ *\| */);
                d.tokens.push(l);
              } else if (t && (o = d.rules.paragraph.exec(e)))
                (e = e.substring(o[0].length)),
                  d.tokens.push({
                    type: 'paragraph',
                    text:
              ...
              else if ((o = d.rules.text.exec(e)))
                (e = e.substring(o[0].length)),
                  d.tokens.push({ type: 'text', text: o[0] });
              else if (e)
        ...
        (p._inside = /(?:\[[^\]]*\]|[^\[\]]|\](?=[^\[]*\]))*/),
          ...
          (n.prototype.output = function (e) {
            for (var t, n, r, i, a = this, s = ''; e; )
              if ((i = a.rules.escape.exec(e)))
                (e = e.substring(i[0].length)), (s += i[1]);
              else if ((i = a.rules.autolink.exec(e)))
                (e = e.substring(i[0].length)),
                  '@' === i[2]
                    ? ((n =
                        ':' === i[1].charAt(6)
                          ? a.mangle(i[1].substring(7))
                          : a.mangle(i[1])),
                      (r = a.mangle('mailto:') + n))
                    : ((n = o(i[1])), (r = n)),
                  (s += a.renderer.link(r, null, n));
              else if (a.inLink || !(i = a.rules.url.exec(e))) {
                if ((i = a.rules.tag.exec(e)))
                  !a.inLink && /^<a /i.test(i[0])
                    ? (a.inLink = !0)
                    : a.inLink && /^<\/a>/i.test(i[0]) && (a.inLink = !1),
                    (e = e.substring(i[0].length)),
                    (s += a.options.sanitize
                      ? a.options.sanitizer
                        ? a.options.sanitizer(i[0])
                        : o(i[0])
                      : i[0]);
                else if ((i = a.rules.link.exec(e)))
                  (e = e.substring(i[0].length)),
                    (a.inLink = !0),
                    (s += a.outputLink(i, { href: i[2], title: i[3] })),
                    (a.inLink = !1);
                else if (
                  (i = a.rules.reflink.exec(e)) ||
                  (i = a.rules.nolink.exec(e))
                ) {
                  if (
                    ((e = e.substring(i[0].length)),
                    (t = (i[2] || i[1]).replace(/\s+/g, ' ')),
                    !(t = a.links[t.toLowerCase()]) || !t.href)
                  ) {
                    (s += i[0].charAt(0)), (e = i[0].substring(1) + e);
                    continue;
                  }
                  (a.inLink = !0), (s += a.outputLink(i, t)), (a.inLink = !1);
                } else if ((i = a.rules.strong.exec(e)))
                  (e = e.substring(i[0].length)),
                    (s += a.renderer.strong(a.output(i[2] || i[1])));
                else if ((i = a.rules.em.exec(e)))
                  (e = e.substring(i[0].length)),
                    (s += a.renderer.em(a.output(i[2] || i[1])));
                else if ((i = a.rules.code.exec(e)))
                  (e = e.substring(i[0].length)),
                    (s += a.renderer.codespan(o(i[2], !0)));
                else if ((i = a.rules.br.exec(e)))
                  (e = e.substring(i[0].length)), (s += a.renderer.br());
                else if ((i = a.rules.del.exec(e)))
                  (e = e.substring(i[0].length)),
                    (s += a.renderer.del(a.output(i[1])));
                else if ((i = a.rules.text.exec(e)))
                  (e = e.substring(i[0].length)),
                    (s += a.renderer.text(o(a.smartypants(i[0]))));
                else if (e)
                  throw new Error('Infinite loop on byte: ' + e.charCodeAt(0));
              } else
                (e = e.substring(i[0].length)),
            ...
            switch (this.token.type) {
              ...
              case 'list_item_start':
                for (var a = ''; 'list_item_end' !== this.next().type; )
                  a += 'text' === e.token.type ? e.parseText() : e.tok();
        ...
        (function () {
          return this || ('undefined' != typeof window ? window : Te);
        })(),
      );
    }),
    Ae = C(function (e) {
            ...
            r = (t.Prism = {
              ...
              highlightAll: function (e, t) {
                ...
                for (
                  ...
                  r.highlightElement(i, !0 === e, n.callback);
              },
                ...
                l &&
                  ...
                  /pre/i.test(l.nodeName) &&
                    (l.className =
                      ...
                      a);
                var u = n.textContent,
                  c = { element: n, language: a, grammar: s, code: u };
                if (
                      ...
                      for (
                        ...
                        if (!(b instanceof i)) {
                          ...
                          var k = c.exec(b),
                            w = 1;
                          if (!k && d && v != o.length - 1) {
                            if (((c.lastIndex = y), !(k = c.exec(e)))) break;
                            for (
                              var x = k.index + (p ? k[1].length : 0),
                          ...
                          if (k) {
                            ...
                            var x = k.index + f,
                              ...
                              $ = [v, w];
                            E && $.push(E);
                            var A = new i(s, h ? r.tokenize(k, h) : k, g, k, d);
                            $.push(A),
                              T && $.push(T),
                              Array.prototype.splice.apply(o, $);
                          }
                        }
                      }
                    }
              ...
              ? (t.addEventListener(
                  ...
                  function (e) {
                    var n = JSON.parse(e.data),
                      ...
                      o = n.code,
                      a = n.immediateClose;
                    t.postMessage(r.highlight(o, r.languages[i], i)),
                      a && t.close();
                  },
                  !1,
                ),
  ...
  var je = decodeURIComponent,
    ...
    He = function (t, n) {
      ...
      var i,
        o = this._initRenderer(),
        a = t.markdown || {};
      r(a)
        ? (i = a($e, o))
        : ($e.setOptions(se(a, { renderer: se(o, a.renderer) })), (i = $e)),
        (this.compile = e(function (e) {
          var n = '';
          return e ? ((n = i(e)), (n = t.noEmoji ? n : A(n)), T.clear(), n) : e;
        }));
    };
  (He.prototype.matchNotCompileLink = function (e) {
    for (var t = this.config.noCompileLinks, n = 0; n < t.length; n++) {
      var r = t[n];
      if ((Fe[r] || (Fe[r] = new RegExp('^' + r + '$'))).test(e)) return e;
    }
  }),
    (He.prototype._initRenderer = function () {
      var e = new $e.Renderer(),
        t = this,
        n = t.linkTarget,
        r = t.router,
        i = t.contentBase,
      ...
      (a.heading = e.heading =
        ...
        (a.link = e.link =
          function (e, t, i) {
            ...
            return (
              (t = l),
              /:|(\/{2})/.test(e) || o.matchNotCompileLink(e) || u.ignore
                ? (a += ' target="' + n + '"')
                : (e = r.toURL(e, null, r.getCurrentPath())),
              u.target && (a += ' target=' + u.target),
              u.disabled && ((a += ' disabled'), (e = 'javascript:void(0)')),
              t && (a += ' title="' + t + '"'),
              '<a href="' + e + '"' + a + '>' + i + '</a>'
            );
          }),
    ...
    (He.prototype.sidebar = function (e, t) {
      var n = this.router.getCurrentPath(),
        r = '';
      if (e)
        (r = this.compile(e)),
          (r = r && r.match(/<ul[^>]*>([\s\S]+)<\/ul>/g)[0]);
      else {
    ...
    (He.prototype.subSidebar = function (e) {
      ...
      i[0] && i[0].ignoreAllSubs && i.splice(0),
        i[0] && 1 === i[0].level && i.shift();
      for (var o = 0; o < i.length; o++)
        i[o].ignoreSubHeading && i.splice(o, 1) && o--;
      var a = r[t] || L(i, e);
      return (r[t] = a), (this.toc = []), b(a, '<ul class="app-sub-sidebar">');
    }),
    (He.prototype.article = function (e) {
      return this.compile(e);
    }),
    (He.prototype.cover = function (e) {
  ...
  var ze = ge.title,
    ...
    Ye = !0,
    Ze = 0,
    Ge = ge.scrollingElement || ge.documentElement,
    Xe = {},
    Ve = function (e) {
      this.config = e;
    };
  (Ve.prototype.getBasePath = function () {
    return this.config.basePath;
  }),
    (Ve.prototype.getFile = function (e, t) {
      e = e || this.getCurrentPath();
      var n = this,
        r = n.config,
        i = this.getBasePath();
      return (
        (e = r.alias ? V(e, r.alias) : e),
        (e = J(e)),
        (e = '/README.md' === e ? r.homepage || e : e),
        (e = qe(e) ? e : j(i, e)),
        t && (e = e.replace(new RegExp('^' + i), '')),
        e
      );
    }),
    (Ve.prototype.onchange = function (e) {
      void 0 === e && (e = n), e();
    }),
    (Ve.prototype.getCurrentPath = function () {}),
    (Ve.prototype.normalize = function () {}),
    (Ve.prototype.parse = function () {}),
    (Ve.prototype.toURL = function () {});
  var Je = e(function (e) {
      return e.replace('#', '?id=');
    }),
    Qe = (function (e) {
      ...
      return (
        ...
        (t.prototype.getBasePath = function () {
          ...
          return /^(\/|https?:)/g.test(t) ? t : Re(e + '/' + t);
        }),
        ...
        (t.prototype.normalize = function () {
          ...
          if (((e = Je(e)), '/' === e.charAt(0))) return Q(e);
          Q('/' + e);
        }),
        (t.prototype.parse = function (e) {
          ...
          return (
            ...
            { path: e, file: this.getFile(e, !0), query: P(t) }
          );
        }),
      ...
      return (
        ...
        (t.prototype.parse = function (e) {
          ...
          return (
            ...
            { path: e, file: this.getFile(e), query: P(t) }
          );
        }),
        (t.prototype.toURL = function (e, t, n) {
          var r = n && '#' === e[0],
  ...
  !(function (e) {
    ...
    (function (e) {
      (e._renderTo = function (e, t, n) {
        ...
        (e._renderSidebar = function (e) {
          ...
          var o = R(this.router, '.sidebar-nav', !0, !0);
          i && o
            ? (o.parentNode.innerHTML += this.compiler.subSidebar(r) || '')
            : this.compiler.subSidebar(),
            this._bindEventOnRendered(o);
        }),
        (e._bindEventOnRendered = function (e) {
          var t = this.config,
            n = t.autoHeader,
            r = t.auto2top;
          if ((I(this.router), n && e)) {
            var i = a('#main'),
              o = i.children[0];
            if (o && 'H1' !== o.tagName) {
              var s = u('h1');
        ...
        (e._renderMain = function (e, t) {
          var n = this;
          if ((void 0 === t && (t = {}), !e)) return Z.call(this, e);
          o(this, 'beforeEach', e, function (e) {
            var r = n.isHTML ? e : n.compiler.compile(e);
            t.updatedAt && (r = Y(r, t.updatedAt, n.config.formatUpdated)),
              o(n, 'afterEach', r, function (e) {
                return Z.call(n, e);
              });
          });
        }),
        (e._renderCover = function (e) {
          var t = a('.cover');
          if (!e) return void f(t, 'remove', 'show');
          f(t, 'add', 'show');
          ...
          if (r) {
            if ('color' === r[2]) t.style.background = r[1] + (r[3] || '');
            else {
              var i = r[1];
              f(t, 'add', 'has-mask'),
                qe(r[1]) || (i = j(this.router.getBasePath(), r[1])),
    ...
    (function (e) {
      e.$resetEvents = function () {
        D(this.route.path, this.route.query.id), R(this.router, 'nav');
      };
    })(nt),
    (function () {
      (window.Docsify = { util: tt, dom: ye, get: _, slugify: T }),
