...
export const POSITIVE: CorpusCase[] = [
  ...
  // #808: string participant labels
  { name: 'participant with string label', src: 'Alice as "The User"' },
  { name: 'annotated participant with string label', src: '@Actor Alice as "The User"' },
  { name: 'annotated participant with identifier label', src: '@Actor Alice as TheUser' },
  { name: 'annotated participant with unicode string label and color', src: '@Actor Alice as "用户" #FF0000' },
  // #809: Unicode/non-ASCII participant names
  { name: 'bare Chinese participant', src: '用户' },
  { name: 'annotated Chinese participant', src: '@Actor 用户' },
  { name: 'Chinese async message', src: '用户->服务: 请求' },
  { name: 'Japanese hiragana participant', src: 'ひらがな' },
  { name: 'Korean hangul participant', src: '한국' },
  { name: 'accented Latin participant', src: 'café' },
  { name: 'Cyrillic participant', src: 'Привет' },
  { name: 'mixed ASCII-CJK-digit participant', src: 'user用户2' },
