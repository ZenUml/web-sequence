 ...
 */,
  (function (e, t) {
    ...
    function a(e) {
      var t = {};
      return (
        ge.each(e.match(Le) || [], function (e, n) {
          t[n] = !0;
        }),
        t
      );
    ...
    function g(e, t, n, r) {
      var i,
        ...
        l = (ge.cssNumber[t] || ('px' !== c && +u)) && _e.exec(ge.css(e, t));
      if (l && l[3] !== c) {
        (c = c || l[3]), (n = n || []), (l = +u || 1);
        do {
    ...
    function j(e, t) {
      ...
      if (1 === t.nodeType) {
        if (
          $e.hasData(e) &&
          ((o = $e.access(e)), (s = $e.set(t, o)), (c = o.events))
        ) {
    ...
    function L(e, t, r, i) {
      ...
      if (
        ...
        for (a = ge.map(y(o, 'script'), k), u = a.length; f < d; f++)
          (c = o),
            f !== p &&
              ((c = ge.clone(c, !0, !0)), u && ge.merge(a, y(c, 'script'))),
            r.call(e[f], c, f);
        if (u)
          for (
            l = a[a.length - 1].ownerDocument, ge.map(a, N), f = 0;
            f < u;
            f++
          )
            (c = a[f]),
    ...
    function D(e, t, n) {
      for (var r, i = t ? ge.filter(t, e) : e, o = 0; null != (r = i[o]); o++)
        n || 1 !== r.nodeType || ge.cleanData(y(r)),
          r.parentNode &&
            (n && ge.contains(r.ownerDocument, r) && x(y(r, 'script')),
    ...
    function H(e, t, n, r, i) {
      ...
      for (
        ...
        'margin' === n && (s += ge.css(e, n + Me[o], !0, i)),
          r
            ? ('content' === n && (s -= ge.css(e, 'padding' + Me[o], !0, i)),
              'margin' !== n &&
                (s -= ge.css(e, 'border' + Me[o] + 'Width', !0, i)))
            : ((s += ge.css(e, 'padding' + Me[o], !0, i)),
              'padding' !== n &&
                (s += ge.css(e, 'border' + Me[o] + 'Width', !0, i)));
      return s;
    }
    ...
    var be =
      ...
      (function (e) {
        function t(e, t, n, r) {
          ...
          if (
            !r &&
            ((t ? t.ownerDocument || t : M) !== q && O(t), (t = t || q), $)
          ) {
            if (11 !== h && (u = ve.exec(e)))
              if ((i = u[1])) {
                if (9 === h) {
          ...
          return (
            ...
            r(function (r, s, a, u) {
              var c,
                ...
                y = !e || (!r && t) ? g : v(g, d, e, a, u),
                x = n ? (o || (r ? e : h || i) ? [] : s) : y;
              if ((n && n(y, x, a, u), i))
                for (c = v(x, p), i(c, [], a, u), l = c.length; l--; )
                  (f = c[l]) && (x[p[l]] = !(y[p[l]] = f));
              if (r) {
                if (o || e) {
                  if (o) {
        ...
        try {
          K.apply((Y = Z.call(M.childNodes)), M.childNodes),
        ...
        (T = t.support = {}),
            ...
            function (e) {
              ...
              return r !== q && 9 === r.nodeType && r.documentElement
                ? ((q = r),
                  ...
                  (H = []),
                  (P = []),
                  (T.qsa = me.test(q.querySelectorAll)) &&
                    (i(function (e) {
                    ...
                    ? function (e, t) {
                        ...
                        return (
                          ...
                          (!T.sortDetached &&
                            ...
                            ? e === q || (e.ownerDocument === M && R(M, e))
                              ? -1
                              : t === q || (t.ownerDocument === M && R(M, t))
                                ? 1
                                : L
                                  ? ee(L, e) - ee(L, t)
                                  : 0
          ...
          (t.attr = function (e, t) {
            ...
            var n = S.attrHandle[t.toLowerCase()],
              r =
                n && Q.call(S.attrHandle, t.toLowerCase())
                  ? n(e, t, !$)
                  : undefined;
            return r !== undefined
              ? r
        ...
        return (
            ...
            function (e, t, n, r) {
              ...
              if (((n = n || []), 1 === l.length)) {
                if (
                  ...
                  if (
                    !(t = (S.find.ID(s.matches[0].replace(xe, be), t) || [])[0])
                  )
                    return n;
                  c && (t = t.parentNode),
          ...
          (T.sortStable = _.split('').sort(U).join('') === _),
    ...
    (ge.filter = function (e, t, n) {
      ...
      ge.fn.extend({
        ...
        is: function (e) {
          return !!o(
            this,
            'string' == typeof e && Se.test(e) ? ge(e) : e || [],
            !1,
          ).length;
        },
      });
        ...
        function (e, t) {
          ge.fn[e] = function (n, r) {
            ...
            return (
              ...
              this.length > 1 &&
                (Ae[e] || ge.uniqueSort(i), je.test(e) && i.reverse()),
              this.pushStack(i)
            );
          };
        },
      ...
      ge.extend({
        ...
        ready: function (e) {
          (!0 === e ? --ge.readyWait : ge.isReady) ||
            ((ge.isReady = !0),
            (!0 !== e && --ge.readyWait > 0) || Oe.resolveWith(ne, [ge]));
        },
      }),
      ...
      ge.fn.extend({
        data: function (e, t) {
          ...
          if (e === undefined) {
            if (
              this.length &&
              ((i = Pe.get(o)), 1 === o.nodeType && !$e.get(o, 'hasDataAttrs'))
            ) {
              for (n = s.length; n--; )
                s[n] &&
                  ((r = s[n].name),
    ...
    ge.extend({
      ...
      clone: function (e, t, n) {
        ...
        return (
          (s = y(a, 'script')), s.length > 0 && x(s, !u && y(e, 'script')), a
        );
      },
              ...
              if (
                ...
                try {
                  for (; n < r; n++)
                    (t = this[n] || {}),
                      1 === t.nodeType &&
                        (ge.cleanData(y(t, !1)), (t.innerHTML = e));
                  t = 0;
                } catch (e) {}
              }
        ...
        replaceWith: function () {
          ...
          return L(
            ...
            function (t) {
              ...
              ge.inArray(this, e) < 0 &&
                (ge.cleanData(y(this)), n && n.replaceChild(t, this));
            },
            e,
          );
        },
        ...
        ge.cssHooks[t] = {
          ...
          set: function (e, n, r) {
            var i,
              ...
              s =
                r &&
                H(e, t, r, 'border-box' === ge.css(e, 'boxSizing', !1, o), o);
            return (
              s &&
                (i = _e.exec(n)) &&
                'px' !== (i[3] || 'px') &&
            ...
            return 'undefined' == typeof e.getAttribute
              ...
              : ((1 === o && ge.isXMLDoc(e)) ||
                  (i =
                    ...
                    (ge.expr.match.bool.test(t) ? yt : undefined)),
                n !== undefined
                  ? null === n
      ...
      trigger: function (t, n, r, i) {
        ...
        if (
          ...
          if (!i && !f.noBubble && !ge.isWindow(r)) {
            for (
              u = f.delegateType || p, St.test(u + p) || (s = s.parentNode);
              s;
              s = s.parentNode
            )
              d.push(s), (a = s);
          ...
          for (o = 0; (s = d[o++]) && !t.isPropagationStopped(); )
            (t.type = o > 1 ? u : f.bindType || p),
              (l = ($e.get(s, 'events') || {})[t.type] && $e.get(s, 'handle')),
              l && l.apply(s, n),
              (l = c && s[c]) &&
                l.apply &&
                Fe(s) &&
      ...
      ge.extend({
        ...
        ajax: function (t, n) {
            ...
            l ||
              ...
              c
                ? (h.ifModified &&
                    ...
                    (w = S.getResponseHeader('etag')) && (ge.etag[o] = w)),
                  204 === t || 'HEAD' === h.type
                    ? (T = 'nocontent')
                    : 304 === t
                      ? (T = 'notmodified')
              ...
              (S.status = t),
              (S.statusText = (n || T) + ''),
              c ? v.resolveWith(g, [d, T, S]) : v.rejectWith(g, [S, T, p]),
              S.statusCode(x),
              (x = undefined),
              f &&
                m.trigger(c ? 'ajaxSuccess' : 'ajaxError', [S, h, c ? d : p]),
              y.fireWith(g, [S, T]),
              f &&
          ...
          (f = ge.event && h.global),
            ...
            h.ifModified &&
              (ge.lastModified[o] &&
                S.setRequestHeader('If-Modified-Since', ge.lastModified[o]),
              ge.etag[o] && S.setRequestHeader('If-None-Match', ge.etag[o])),
          ...
          if (
            ...
            if (((S.readyState = 1), f && m.trigger('ajaxSend', [S, h]), l))
              return S;
            h.async &&
              h.timeout > 0 &&
    ...
    ge.ajaxSetup({
      ...
      ge.each(['top', 'left'], function (e, t) {
        ge.cssHooks[t] = q(pe.pixelPosition, function (e, n) {
          if (n)
            return (n = O(e, t)), st.test(n) ? ge(e).position()[t] + 'px' : n;
        });
      }),
    ...
    return (
      (ge.noConflict = function (t) {
        return (
          e.$ === ge && (e.$ = Ut), t && e.jQuery === ge && (e.jQuery = Xt), ge
        );
      }),
      t || (e.jQuery = e.$ = ge),
      ge
     ...
     */,
      ...
      (e.Pipeline.prototype.run = function (e) {
        for (
          ...
          for (
            var o = e[i], s = 0;
            s < r && void 0 !== (o = this._stack[s](o, i, e));
            s++
          );
          void 0 !== o && t.push(o);
        }
          ...
          ? (n.forEach(function (t, n, s) {
              var a = (1 / s.length) * this._fields.length * o,
                ...
                c = this.tokenStore.expand(t).reduce(function (n, i) {
                  ...
                  return (
                    o > -1 && r.insert(o, a * s * c),
                    Object.keys(u.tokenStore.get(i)).forEach(function (e) {
                      l.add(e);
                    }),
                    n.union(l)
                  );
      ...
      (e.stopWordFilter = function (t) {
        if (-1 === e.stopWordFilter.stopWords.indexOf(t)) return t;
      }),
  ...
  (function () {
    ...
    var s,
      a,
      u = { element: 'span', className: 'search-highlight' },
      c = 0,
      l = 0,
      f = new lunr.Index();
    f.ref('id'),
      f.field('title', { boost: 10 }),
      f.field('body'),
      f.pipeline.add(lunr.trimmer, lunr.stopWordFilter),
      $(e),
      $(n);
  })();
