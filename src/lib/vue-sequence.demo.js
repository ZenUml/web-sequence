		...
		/***/ (function(module, exports, __webpack_require__) {
			...
			(function webpackUniversalModuleDefinition(root, factory) {
				if(true)
					...
					exports["sequenceParser"] = factory(require("fs"));
				else
					root["sequenceParser"] = factory(root["fs"]);
 ...
 */
						...
						exports.CharStreams = __webpack_require__(35).CharStreams;
...
// jshint ignore: start
						...
						sequenceLexer.GT = 7;
						sequenceLexer.LT = 8;
						sequenceLexer.GTEQ = 9;
						sequenceLexer.LTEQ = 10;
						sequenceLexer.PLUS = 11;
						sequenceLexer.MINUS = 12;
						sequenceLexer.MULT = 13;
						sequenceLexer.DIV = 14;
						sequenceLexer.MOD = 15;
						sequenceLexer.POW = 16;
						sequenceLexer.NOT = 17;
						sequenceLexer.SCOL = 18;
						sequenceLexer.ASSIGN = 19;
						sequenceLexer.OPAR = 20;
						sequenceLexer.CPAR = 21;
						sequenceLexer.OBRACE = 22;
						sequenceLexer.CBRACE = 23;
						sequenceLexer.TRUE = 24;
						sequenceLexer.FALSE = 25;
						sequenceLexer.NIL = 26;
						sequenceLexer.IF = 27;
						sequenceLexer.ELSE = 28;
						sequenceLexer.WHILE = 29;
						sequenceLexer.ID = 30;
						sequenceLexer.INT = 31;
						sequenceLexer.FLOAT = 32;
						sequenceLexer.STRING = 33;
						sequenceLexer.COMMENT = 34;
						sequenceLexer.SPACE = 35;
						sequenceLexer.OTHER = 36;
						...
						sequenceLexer.prototype.symbolicNames = [ null, null, null, "OR", "AND",
							"EQ", "NEQ", "GT", "LT", "GTEQ",
							"LTEQ", "PLUS", "MINUS", "MULT",
							"DIV", "MOD", "POW", "NOT", "SCOL",
							"ASSIGN", "OPAR", "CPAR", "OBRACE",
							"CBRACE", "TRUE", "FALSE", "NIL",
							"IF", "ELSE", "WHILE", "ID", "INT",
							"FLOAT", "STRING", "COMMENT",
							"SPACE", "OTHER" ];

						sequenceLexer.prototype.ruleNames = [ "T__0", "T__1", "OR", "AND", "EQ",
							"NEQ", "GT", "LT", "GTEQ", "LTEQ",
							"PLUS", "MINUS", "MULT", "DIV", "MOD",
							"POW", "NOT", "SCOL", "ASSIGN", "OPAR",
...
// jshint ignore: start
						var antlr4 = __webpack_require__(12);
						var sequenceListener = __webpack_require__(20).sequenceListener;
						...
						var symbolicNames = [ null, null, null, "OR", "AND", "EQ", "NEQ", "GT",
							"LT", "GTEQ", "LTEQ", "PLUS", "MINUS", "MULT", "DIV",
							"MOD", "POW", "NOT", "SCOL", "ASSIGN", "OPAR", "CPAR",
							"OBRACE", "CBRACE", "TRUE", "FALSE", "NIL", "IF",
							"ELSE", "WHILE", "ID", "INT", "FLOAT", "STRING", "COMMENT",
							"SPACE", "OTHER" ];

						var ruleNames =  [ "prog", "block", "stat", "message", "ret", "to", "methodName",
						...
						sequenceParser.OR = 3;
						sequenceParser.AND = 4;
						sequenceParser.EQ = 5;
						sequenceParser.NEQ = 6;
						sequenceParser.GT = 7;
						sequenceParser.LT = 8;
						sequenceParser.GTEQ = 9;
						sequenceParser.LTEQ = 10;
						sequenceParser.PLUS = 11;
						sequenceParser.MINUS = 12;
						sequenceParser.MULT = 13;
						sequenceParser.DIV = 14;
						sequenceParser.MOD = 15;
						sequenceParser.POW = 16;
						sequenceParser.NOT = 17;
						sequenceParser.SCOL = 18;
						sequenceParser.ASSIGN = 19;
						sequenceParser.OPAR = 20;
						sequenceParser.CPAR = 21;
						sequenceParser.OBRACE = 22;
						sequenceParser.CBRACE = 23;
						sequenceParser.TRUE = 24;
						sequenceParser.FALSE = 25;
						sequenceParser.NIL = 26;
						sequenceParser.IF = 27;
						sequenceParser.ELSE = 28;
						sequenceParser.WHILE = 29;
						sequenceParser.ID = 30;
						sequenceParser.INT = 31;
						sequenceParser.FLOAT = 32;
						sequenceParser.STRING = 33;
						sequenceParser.COMMENT = 34;
						sequenceParser.SPACE = 35;
						sequenceParser.OTHER = 36;

						sequenceParser.RULE_prog = 0;
						sequenceParser.RULE_block = 1;
						sequenceParser.RULE_stat = 2;
						sequenceParser.RULE_message = 3;
						sequenceParser.RULE_ret = 4;
						sequenceParser.RULE_to = 5;
						sequenceParser.RULE_methodName = 6;
						sequenceParser.RULE_parameters = 7;
						sequenceParser.RULE_parameter = 8;
						sequenceParser.RULE_alt = 9;
						sequenceParser.RULE_ifBlock = 10;
						sequenceParser.RULE_elseIfBlock = 11;
						sequenceParser.RULE_elseBlock = 12;
						sequenceParser.RULE_braceBlock = 13;
						sequenceParser.RULE_loop = 14;
						sequenceParser.RULE_expr = 15;
						sequenceParser.RULE_atom = 16;
						sequenceParser.RULE_parExpr = 17;
						...
						sequenceParser.prototype.block = function() {
							...
							this.enterRule(localctx, 2, sequenceParser.RULE_block);
							...
							try {
								...
								while(((((_la - 27)) & ~0x1f) == 0 && ((1 << (_la - 27)) & ((1 << (sequenceParser.IF - 27)) | (1 << (sequenceParser.WHILE - 27)) | (1 << (sequenceParser.ID - 27)) | (1 << (sequenceParser.OTHER - 27)))) !== 0)) {
									this.state = 39;
									this.stat();
									this.state = 44;
									this._errHandler.sync(this);
						...
						sequenceParser.prototype.stat = function() {
							...
							this.enterRule(localctx, 4, sequenceParser.RULE_stat);
							try {
								this.state = 50;
								this._errHandler.sync(this);
						...
						MessageContext.prototype.ret = function() {
						...
						sequenceParser.prototype.message = function() {
							...
							this.enterRule(localctx, 6, sequenceParser.RULE_message);
							var _la = 0; // Token type
							try {
								this.enterOuterAlt(localctx, 1);
								this.state = 55;
								...
								while(_la===sequenceParser.OPAR) {
									...
									this._errHandler.sync(this);
									_la = this._input.LA(1);
									if(((((_la - 24)) & ~0x1f) == 0 && ((1 << (_la - 24)) & ((1 << (sequenceParser.TRUE - 24)) | (1 << (sequenceParser.FALSE - 24)) | (1 << (sequenceParser.NIL - 24)) | (1 << (sequenceParser.ID - 24)) | (1 << (sequenceParser.INT - 24)) | (1 << (sequenceParser.FLOAT - 24)) | (1 << (sequenceParser.STRING - 24)))) !== 0)) {
										this.state = 64;
										this.parameters();
									}
						...
						sequenceParser.prototype.methodName = function() {
							...
							this.enterRule(localctx, 12, sequenceParser.RULE_methodName);
							try {
								this.enterOuterAlt(localctx, 1);
								this.state = 84;
								this.match(sequenceParser.ID);
						...
						sequenceParser.prototype.parameters = function() {
							...
							this.enterRule(localctx, 14, sequenceParser.RULE_parameters);
							var _la = 0; // Token type
							try {
								this.enterOuterAlt(localctx, 1);
								this.state = 86;
						...
						sequenceParser.prototype.parameter = function() {
							...
							this.enterRule(localctx, 16, sequenceParser.RULE_parameter);
							try {
								this.state = 96;
								this._errHandler.sync(this);
						...
						sequenceParser.prototype.alt = function() {
							...
							this.enterRule(localctx, 18, sequenceParser.RULE_alt);
							var _la = 0; // Token type
							try {
								this.enterOuterAlt(localctx, 1);
								this.state = 98;
						...
						sequenceParser.prototype.ifBlock = function() {
							...
							this.enterRule(localctx, 20, sequenceParser.RULE_ifBlock);
							try {
								this.enterOuterAlt(localctx, 1);
								this.state = 108;
						...
						sequenceParser.prototype.elseIfBlock = function() {
							...
							this.enterRule(localctx, 22, sequenceParser.RULE_elseIfBlock);
							try {
								this.enterOuterAlt(localctx, 1);
								this.state = 112;
						...
						sequenceParser.prototype.elseBlock = function() {
							...
							this.enterRule(localctx, 24, sequenceParser.RULE_elseBlock);
							try {
								this.enterOuterAlt(localctx, 1);
								this.state = 117;
								this.match(sequenceParser.ELSE);
						...
						sequenceParser.prototype.braceBlock = function() {
							...
							this.enterRule(localctx, 26, sequenceParser.RULE_braceBlock);
							try {
								this.enterOuterAlt(localctx, 1);
								this.state = 120;
								this.match(sequenceParser.OBRACE);
						...
						sequenceParser.prototype.loop = function() {
							...
							this.enterRule(localctx, 28, sequenceParser.RULE_loop);
							try {
								this.enterOuterAlt(localctx, 1);
								this.state = 124;
						...
						sequenceParser.prototype.expr = function(_p) {
							...
							var _startState = 30;
							this.enterRecursionRule(localctx, 30, sequenceParser.RULE_expr, _p);
							var _la = 0; // Token type
							try {
								this.enterOuterAlt(localctx, 1);
								this.state = 134;
						...
						sequenceParser.prototype.atom = function() {
							...
							this.enterRule(localctx, 32, sequenceParser.RULE_atom);
							var _la = 0; // Token type
							try {
								this.state = 164;
								this._errHandler.sync(this);
						...
						sequenceParser.prototype.parExpr = function() {
							...
							this.enterRule(localctx, 34, sequenceParser.RULE_parExpr);
							try {
								this.enterOuterAlt(localctx, 1);
								this.state = 166;
								this.match(sequenceParser.OPAR);
...
///
						...
						var Token = __webpack_require__(1).Token;
						var BufferedTokenStream = __webpack_require__(34).BufferedTokenStream;
 ...
 */
					...
					/***/ (function(module, exports, __webpack_require__) {
						...
						var antlr4  = __webpack_require__(12)
						var sequenceLexer = __webpack_require__(32)
						var sequenceParser = __webpack_require__(33)
						var sequenceListener = __webpack_require__(20)
						...
						function rootContext(code) {
							...
							return parser._syntaxErrors ? null : parser.prog().block();
						}
...
// auto install in dist mode
		...
		/***/ (function(module, __webpack_exports__, __webpack_require__) {
			...
			/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_SeqDiagram_vue__ = __webpack_require__(14);
			/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_SeqDiagram_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__components_SeqDiagram_vue__);
			/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_LifeLine_vue__ = __webpack_require__(11);
			/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_LifeLine_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__components_LifeLine_vue__);
			/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_SelfInteraction_vue__ = __webpack_require__(13);
			/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_SelfInteraction_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__components_SelfInteraction_vue__);
			/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_Interaction_vue__ = __webpack_require__(10);
			/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_Interaction_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5__components_Interaction_vue__);
			/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_Occurrence_vue__ = __webpack_require__(12);
			/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_Occurrence_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6__components_Occurrence_vue__);
			/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_Block_vue__ = __webpack_require__(7);
			/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_Block_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7__components_Block_vue__);
			/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__components_FragmentAlt_vue__ = __webpack_require__(8);
			/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__components_FragmentAlt_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_8__components_FragmentAlt_vue__);
			/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__components_FragmentLoop_vue__ = __webpack_require__(9);
			/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__components_FragmentLoop_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_9__components_FragmentLoop_vue__);
			/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__components_Cosmetic_css__ = __webpack_require__(6);
			/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__components_Cosmetic_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_10__components_Cosmetic_css__);
			/* harmony reexport (default from non-hamory) */ __webpack_require__.d(__webpack_exports__, "SeqDiagram", function() { return __WEBPACK_IMPORTED_MODULE_2__components_SeqDiagram_vue___default.a; });
...
// (runtime-only or standalone) has been set in webpack.base.conf with an alias.
			...
			__WEBPACK_IMPORTED_MODULE_0_vue__["a" /* default */].component('seq-diagram', __WEBPACK_IMPORTED_MODULE_2__components_SeqDiagram_vue___default.a);
			__WEBPACK_IMPORTED_MODULE_0_vue__["a" /* default */].component('life-line', __WEBPACK_IMPORTED_MODULE_3__components_LifeLine_vue___default.a);
			__WEBPACK_IMPORTED_MODULE_0_vue__["a" /* default */].component('interaction', __WEBPACK_IMPORTED_MODULE_5__components_Interaction_vue___default.a);
			__WEBPACK_IMPORTED_MODULE_0_vue__["a" /* default */].component('self-interaction', __WEBPACK_IMPORTED_MODULE_4__components_SelfInteraction_vue___default.a);
			__WEBPACK_IMPORTED_MODULE_0_vue__["a" /* default */].component('occurrence', __WEBPACK_IMPORTED_MODULE_6__components_Occurrence_vue___default.a);
			__WEBPACK_IMPORTED_MODULE_0_vue__["a" /* default */].component('block', __WEBPACK_IMPORTED_MODULE_7__components_Block_vue___default.a);
			__WEBPACK_IMPORTED_MODULE_0_vue__["a" /* default */].component('fragment-alt', __WEBPACK_IMPORTED_MODULE_8__components_FragmentAlt_vue___default.a);
			__WEBPACK_IMPORTED_MODULE_0_vue__["a" /* default */].component('fragment-loop', __WEBPACK_IMPORTED_MODULE_9__components_FragmentLoop_vue___default.a);
			...
			var Store = new __WEBPACK_IMPORTED_MODULE_1_vuex__["a" /* default */].Store({
				...
				getters: {
					centerOf: function centerOf(state) {
						return function (entity) {
							// Always recalculate the center based on element.
							// We get no update when browser simply move the element around.
							// For example, if there were LifeLine A and B, if A is `destroyed`,
							// B will be moved to the left without any hooking method triggered.
							var el = state.entityLocator[entity];
							return el && el.offsetLeft + el.offsetWidth / 2;
						};
					},
				...
				mutations: {
					...
					register: function register(state, payload) {
						state.entityLocator[payload.entity] = payload.el;
					},
					unregister: function unregister(state, payload) {
						state.entityLocator[payload.entity] = undefined;
					},
...
//
			...
			/* harmony default export */ __webpack_exports__["default"] = ({
				...
				props: ['from', 'context'],
				data: function data() {
					// The object must be plain (no stateful behavior).
					return {
						messageWidth: 0, // cannot be put in computed because re-calc is not trigger in computed section
						rightToLeft: false // same as above
					};
				},

				computed: { // only re-computed on reactive dependency (data and props?) changes
				...
				methods: { // `this` automatically bound to the Vue instance
					reposition: function reposition() {
						var centerOfTo = this.$store.getters.centerOf(this.to);
						var centerOfFrom = this.$store.getters.centerOf(this.from);
						var defaultWidth = Math.abs(centerOfTo - centerOfFrom);
						this.messageWidth = this.root ? defaultWidth + 8 : defaultWidth;
						this.rightToLeft = centerOfTo < centerOfFrom;
					}
				},
				updated: function updated() {
					this.reposition();
...
//
			...
			/* harmony default export */ __webpack_exports__["default"] = ({
				...
				props: ['entity'],
				mounted: function mounted() {
					this.$store.commit('register', { entity: this.entity, el: this.$el });
				},
				destroyed: function destroyed() {
...
//
			...
			/* harmony default export */ __webpack_exports__["default"] = ({
				...
				computed: {
					...
					// This is the root of interactions
					block: function block() {
						return __WEBPACK_IMPORTED_MODULE_0_sequence_parser___default.a.RootContext(this.code);
					},
					entities: function entities() {
						return __WEBPACK_IMPORTED_MODULE_0_sequence_parser___default.a.Participants(this.block);
					},
					height: function height() {
						return this.$store.state.height + 120;
					}
				},
				mounted: function mounted() {
					this.updateHeight();
				...
				methods: {
					updateHeight: function updateHeight() {
						this.$store.commit('height', this.$refs.message.offsetHeight);
						this.messageLayerLeft = this.$store.getters.centerOf('User');
					}
				}
			});
...
// removed by extract-text-webpack-plugin
		...
		/***/ (function(module, exports) {
			...
			module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
				return _c('div', {
					staticClass: "seq-diagram sequence-diagram",
					style: ({
					...
					ref: "message",
					staticClass: "message-layer xyz",
					style: ({
						paddingLeft: _vm.messageLayerLeft + 'px'
					}),
					attrs: {
						"id": "message-layer"
					}
		...
		/***/ (function(module, exports) {
			...
			module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
				return _c('div', {
					...
					class: {
						'right-to-left': _vm.rightToLeft, 'root': _vm.root
					},
					style: ({
...
// easier to handle this case. if(!global) { ...}
		...
		/***/ (function(module, __webpack_exports__, __webpack_require__) {
			...
			__WEBPACK_IMPORTED_MODULE_2__main__["Store"].commit('code', 'B.methodB(0, 1) { B.methodA(1, 2) }');
