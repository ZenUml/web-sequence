	...
	return (
		<Dialog.Root open={open} onOpenChange={onClose}>
			<Dialog.Portal>
				...
				<Dialog.Content
					className='text-gray-400 data-[state=open]:animate-contentShow fixed top-[50%] left-[50%] max-h-[85vh] w-[90vw] overflow-hidden max-w-[850px] translate-x-[-50%] translate-y-[-50%] rounded-[6px] bg-black-400 p-[25px] shadow-[hsl(206_22%_7%_/_35%)_0px_10px_38px_-10px,_hsl(206_22%_7%_/_20%)_0px_10px_20px_-15px] focus:outline-none'>
						...
						<div className='flex mt-6 text-sm'>
							<div>
								...
								<div className='flex flex-col gap-3'>
									<p>
										<span className='kbd-shortcut__keys'>Ctrl/⌘ + Shift + ?</span>
										<span className='kbd-shortcut__details'>See keyboard shortcuts</span>
									</p>
									<p>
										<span className='kbd-shortcut__keys'>Ctrl/⌘ + Shift + 5</span>
										<span className='kbd-shortcut__details'>Refresh preview</span>
									</p>
									<p>
										<span className='kbd-shortcut__keys'>Ctrl/⌘ + S</span>
										<span className='kbd-shortcut__details'>Save current creations</span>
									</p>
									<p>
							...
							<div className='ml-6'>
								...
								<div className='flex flex-col gap-3'>
									...
									<p>
										...
										<span className='kbd-shortcut__details'>Select next match</span>
									</p>
									<p>
										<span className='kbd-shortcut__keys'>Ctrl/⌘ + Shift + G</span>
										<span className='kbd-shortcut__details'>Select previous match</span>
									</p>
									<p>
										<span className='kbd-shortcut__keys'>Ctrl/⌘ + Opt/Alt + F</span>
										<span className='kbd-shortcut__details'>Find & replace</span>
									</p>
									<p>
									...
									<p>
										...
										<span className='kbd-shortcut__details'>Indent code right</span>
									</p>
									<p>
										<span className='kbd-shortcut__keys'>Ctrl/⌘ + [</span>
										<span className='kbd-shortcut__details'>Indent code left</span>
									</p>
									<p>
									...
									<p>
										<span className='kbd-shortcut__keys'>Ctrl/⌘ + /</span>
										<span className='kbd-shortcut__details'>Single line comment</span>
									</p>
									<p>
