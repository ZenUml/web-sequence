				...
				<Dialog.Content
					...
					<div className='mt-6 w-full'>
						<table className='w-full'>
							<tr className=''>
								<th className='text-left font-normal text-base p-3 font-semibold'>Feature</th>
								<th className='text-left font-normal text-base p-3 font-semibold'>Sample</th>
							</tr>
							<tr className=''>
								<td className='text-sm px-3 py-2'>Participant</td>
								<td className='text-sm px-3 py-2'>
									<pre lang='javascript' className='bg-black-600/30  p-2 rounded'>
										<code className='font-mono'>
												ParticipantA<br />ParticipantB
										</code>
									</pre>
								</td>
							</tr>
							...
							<tr className=''>
								...
								<td className='px-3 py-2'>
									<pre className='bg-black-600/30 p-2 rounded-lg'>
										<code className='font-mono'>Alice-&gt;Bob: How are you?</code>
									</pre>
								</td>
							</tr>
							<tr>
