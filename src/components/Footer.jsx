...
export default class Footer extends Component {
	...
	render() {
		return (
			<div id='footer' class='flex w-full items-center justify-between z-10 bg-black py-4 px-6 text-gray-500 text-xs'>
				{window.zenumlDesktop ? (
					...
					<div class='flex items-center gap-4'>
						...
						<a className='hover:opacity-80 duration-200'
							 href={'https://marketplace.atlassian.com/apps/1218380/zenuml-sequence-diagram'}
							 target='_blank'>&nbsp;Confluence Plugin&nbsp;</a>
						<a className='hover:opacity-80 duration-200'
				...
				<div class='flex gap-4'>
					<a className='hover:opacity-80 duration-200' href={'End-User-License-Agreement/index.html'}
						 target='_blank'>&nbsp;End User
						License Agreement&nbsp;</a>
					<a className='hover:opacity-80 duration-200' href={'privacy-policy/privacy-policy.html'}
